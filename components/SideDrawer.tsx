                ...
                <DrawerBody mt={'1rem'}>
                    <Flex width="100%" height={'100%'} alignItems={'center'} justifyContent={'space-evenly'} color={'white'} direction={'column'}>
                        <NextLink href='/' passHref>
                            <Link onClick={onClose} fontSize={"2xl"}>Home</Link>
                        </NextLink>

                        <NextLink href='/projects' passHref>
                            <Link onClick={onClose} fontSize={"2xl"}>Projects</Link>
                        </NextLink>

                        <NextLink href='/resume' passHref>
                            <Link onClick={onClose} fontSize={"2xl"}>Resume</Link>
                        </NextLink>

                        <NextLink href='/contact' passHref>
                            <Link onClick={onClose} fontSize={"2xl"}>Contact</Link>
                        </NextLink>
                    </Flex>
                </DrawerBody>
            </DrawerContent>
