...
import { Box, Button, Divider, Flex, Text, useBreakpointValue } from '@chakra-ui/react';
    ...
    return (
        <Box padding={'2rem'} color={'white'} py={'3rem'} bg={'primary'} minHeight={"100vh"}>
            ...
            <Flex mt={'1rem'} justifyContent={{ base: 'center', lg: 'end' }}>
                <Button size={sizeResponsive} variant={'solid'} _hover={{ background: 'accent' }} rightIcon={<DownloadIcon />}>Download</Button>
            </Flex>
